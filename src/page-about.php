 ...
 ######  ##     ## ##     ## ######## ######## ##     ##
    ...
    $careerlist = array(
        ...
        array(
            ...
            'txt' => '高校卒業後は桑沢デザイン研究所に進学し、Adobeソフトの扱い方や、一眼レフを用いた写真撮影方法などの基礎的なスキルを身に付けました。<br>2年次からはファッションデザインを専攻しました。衣食住という言葉があるように、私達の日常生活に密接に関わっている分野のデザインだと考えたからです。<br>パターンや縫製などの授業では、服の構造や成り立ち方を論理的に理解していきました。元来直感的に物事を捉える傾向がありましたが、構造などをきちんと知った上で考えるデザインは一回りも二回りも説得力が生まれることを体感しました。桑沢での様々な学びを通して、論理的視点からもものづくりをしていくことを意識するようになりました。<br>卒業制作では「スモッキング」という、布を糸でかがり寄せて浮き上がる面白いテキスタイル表現を用いた洋服を制作しました。',
            'img' => array(
                'kuwa01',
                'kuwa02',
                'kuwa03',
        ...
        array(
            'ym' => '2019年4月 ～ 20年3月',
            'ttl' => '株式会社PJC　企画アシスタント',
            'txt' => 'アパレル業界の上流～下流まで全体像を理解したいという思いから、オリジナルの刺繍生地制作から衣類・雑貨の企画～販売まで一貫して行うミセス向けアパレルブランドに入社し、企画補佐や在庫管理、生産管理、接客、事務作業など幅広い業務を担当しました。',
            'img' => '',
        ),
        array(
            'ym' => '2020年9月 ～ 12月',
            'ttl' => 'テラハウスICA　マークアップWEBデザイン実践科　履修',
            'txt' => '元来興味のあったWEB業界に挑戦したいという思いから、自主学習と4ヶ月間の職業訓練でマークアップ言語とWEBデザインの基礎知識を習得しました。',
            'img' => '',
        ),
        array(
            'ym' => '2021年1月 ～ 5月',
            'ttl' => '株式会社フライングハイワークス　ディレクターアシスタント（アルバイト）',
            'txt' => '訓練校の紹介で約半年弱、WEB制作会社の企画部にて既存サイトの更新業務やディレクター職補佐を担当し、実践環境でWEB制作フローの下地を固めました。',
            'img' => '',
        ),
        array(
            'ym' => '2021年6月 ～ 24年6月',
            'ttl' => '株式会社SPC　WEBクリエイター',
            'txt' => 'WEBサイトやECサイトのデザイン、UI設計、フロント構築、WordPress構築、チラシ制作などを担当しました。',
            'img' => '',
        ),
        array(
            'ym' => '2024年7月～',
            'ttl' => '株式会社マイナビ　デジタルテクノロジー戦略本部　UI/UXデザイナー',
            'txt' => '"マイナビ20XX"のプロダクトをメインに改善施策の立案、年度毎のデザイン業務などを担当。',
            'img' => '',
        ),
    );
    ?>
    ...
    <div class="about__main wrap w1200 sp-wrap">
        ...
        <section class="about__profile double-border-box js-in anime bottom-in" id="profile">
            ...
            $list = array(
                ...
                array(
                    'th' => '好きなこと',
                    'td' => '絵を描くこと・お菓子作り・散歩・昼寝・飲食店リサーチ・競馬・建築物鑑賞・裁判傍聴',
                ),
                array(
                    'th' => '好きな食べ物',
                    'td' => 'スコーン・穴子・オニオンリング',
