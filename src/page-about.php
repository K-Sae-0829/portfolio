 ...
 ######  ##     ## ##     ## ######## ######## ##     ##
    ...
    $careerlist = array(
        ...
        array(
            ...
            'txt' => 'アパレル業界の上流～下流まで全体像を理解したいという思いから、オリジナルの刺繍生地制作から衣類・雑貨の企画～販売まで一貫して行うミセス向けアパレルブランドで企画アシスタントとして1年間、企画補佐や在庫管理、生産管理、接客、事務作業など様々な業務を経験しました。業務内容が多義にわたっていたため、優先順位を付けて効率よくこなせるように心掛けていました。',
            'img' => '',
        ),
        array(
            'ym' => '2021年9月 ～ 12月',
        ...
        array(
            'ym' => '2021年1月 ～ 5月',
            'ttl' => '株式会社フライングハイワークス　アルバイト',
            'txt' => '訓練校の紹介で約半年弱、WEB制作会社の企画部にて既存サイトの更新業務やディレクター職補佐を担当しました。',
            'img' => '',
        ),
        array(
            'ym' => '2021年6月～',
            'ttl' => '株式会社SPC　WEBクリエイター',
            'txt' => 'WEBサイトやECサイトのデザイン、UI設計、フロント構築、WordPress構築などを担当しています。',
            'img' => '',
        ),
    );
    ?>
