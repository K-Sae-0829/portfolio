...
//             'show_ui' => true, // 管理画面の標準UIで制御
//             'query_var' => true, // query_varの対象にする
//             'show_admin_column' => true, // 投稿一覧のカラムに表示
//             'query_var' => $taxName, // 投稿一覧のカラムに表示
//             'hierarchical' => true, // 階層をつける
//             'rewrite' => array(
//                 // 'slug' => '',
//                 'with_front' => false,
//             ),
...
/*
 ...
 ##     ##  ######   ######
*/
// /feed/で発行されるRSSフィードにpost以外の投稿タイプを含める
// function customFeed($vars)
// {
//     if (isset($vars['feed']) && !isset($vars['post_type'])) {
//         $vars['post_type'] = array( // 組み込む投稿タイプを配列で指定
//             'post',
//         );
//     }
//     return $vars;
// }
// add_filter('request', 'customFeed');
